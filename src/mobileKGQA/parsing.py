...
def add_shared_args(parser):
    parser.add_argument('--dataset_name', default='webqsp', type=str)
    parser.add_argument("--bit", default=None)
    parser.add_argument("--domain", default="total", type=str)
    parser.add_argument("--test_domain", default="total", type=str)
    ...
    parser.add_argument('--lm', default='relbert', type=str, choices=["relbert", "gte-large", "gte-qwen2:1.5b"])
    ...
    parser.add_argument('--checkpoint_dir', default='./ckpts/mobileKGQA', type=str)
...
def create_parser_rearev(parser):
    ...
    parser.add_argument('--model_name', default='mobileKGQA', type=str)
