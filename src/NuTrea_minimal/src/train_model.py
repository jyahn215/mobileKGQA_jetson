...
class Trainer_KBQA(object):
    def __init__(self, args, model_name, logger=None):
        ...
        self.model = NuTrea(
            self.args, len(self.entity2id), self.num_kb_relation,
            rel_hidden, rel_mask, rel_inv_hidden, rel_inv_mask).to(self.device)
        ...
        #     self.model.encode_rel_texts(rel_features, rel_features_inv)
    ...
    def train(self, start_epoch, end_epoch):
        ...
        for epoch in range(start_epoch, end_epoch + 1):
            ...
            if (epoch + 1) % eval_every == 0:
                ...
                wandb.log({"Epoch": epoch, "eval_f1": eval_f1, "eval_h1": eval_h1})
                ...
                wandb.log({"Epoch": epoch, "test_f1": test_f1, "test_h1": test_h1})
                wandb.log({"Epoch": epoch, "best_test_f1": self.best_test_f1, "best_test_h1": self.best_test_h1})
    ...
    def evaluate_best(self):
        ...
        wandb.log({"best_h1_test_f1": eval_f1, "best_h1_test_h1": eval_h1})
        ...
        self.logger.info("TEST F1: {:.4f}, H1: {:.4f}".format(eval_f1, eval_h1))
        wandb.log({"best_f1_test_f1": eval_f1, "best_f1_test_h1": eval_h1})
