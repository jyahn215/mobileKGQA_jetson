...
class BaseModel(torch.nn.Module):
    ...
    def __init__(self, args, num_entity, num_relation):
        ...
        print("Entity: {}, Relation: {}".format(num_entity, num_relation))
    ...
    # def encode_rel_texts(self, rel_features, rel_features_inv):
    #     self.rel_feature = rel_features
    #     self.rel_feature.requires_grad = False
    #     self.rel_feature_inv = rel_features_inv
    #     self.rel_feature_inv.requires_grad = False
